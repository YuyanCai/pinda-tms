...
import com.itheima.pinda.service.IPdGoodsTypeService;
...
public class GoodsTypeController {
    ...
    public GoodsTypeDto findById(@PathVariable(name = "id") String id) {
        ...
        if (pdGoodsType != null) {
            BeanUtils.copyProperties(pdGoodsType, dto);
            dto.setTruckTypeIds(truckTypeGoodsTypeService.findAll(null,
                    dto.getId()).stream().map(truckTypeGoodsType ->
